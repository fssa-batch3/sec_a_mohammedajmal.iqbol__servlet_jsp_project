...
<body>
		...
		<div>
			...
			<div class="course-selection-div-videos">
				...
				<div class="scroll-courses-div-stocks">
					...
					try {
						courses = courseService.listCourse(loggedInUserID);
					...
					<div class="first-course2-stocks">
						...
						<div>
							...
							<form method="post" style="margin-left: 20px;">
								<a href="editcourse.jsp?courseId=<%= course.getCourseID() %>" style="padding:7px;width:50px;background-color:dodgerblue;color:white;border:3px dodgerblue;border-radius:5px;">Edit</a>
							</form>
							<form action="../DeleteCourseServlet" method="post" style="width:40px;margin-left: 80px;margin-top: -30px;">
								<input type="hidden" name="courseId"
									value="<%=course.getCourseID()%>">
								<button type="submit" style="padding:7px;width:60px;background-color:red;color:white;border:3px red;border-radius:5px;">Delete</button>
							</form>
							<br>
						</div>
					</div>
	...
	<script src="../assets/js/adminCoursesdd.js"></script>
