...
<body>
   ...
   <div class="loading" id="loader" style="display:none;">
	...
	<ul class="errorMessages" id="errormsg"></ul>
		<div class="contain">
			<div>
				<label for="name">Course Name <span class="required">*</span></label> <input type="text" id="name"
					name="name" value="Complete Stock Trading Course" required><br>
				<br> <label for="coverImage">Cover Image URL <span class="required">*</span></label> <input
					...
					required><br> <br> <label for="timing">Timing <span class="required">*</span></label>
				<input type="text" id="timing" name="timing" value="15hrs" required><br>
				<br> <label for="language">Language <span class="required">*</span></label> <input type="text"
					id="language" name="language" value="Tamil" required><br>
				<br> <label for="markedPrice">Marked Price <span class="required">*</span></label> <input
					type="number" id="markedPrice" name="markedPrice" value="3999"
					required><br> <br> <label for="sellingPrice">Selling
					Price <span class="required">*</span></label> <input type="number" id="sellingPrice" name="sellingPrice"
			...
			<div>
				...
				<br> <br> <label for="instructorName">Instructor
					Name <span class="required">*</span></label> <input type="text" id="instructorName" name="instructorName"
					value="Ajmal" required><br> <br> <label
					for="companyName">Company Name <span class="required">*</span></label> <input type="text"
					id="companyName" name="companyName" value="fresh trading" required><br>
				<br> <label for="companyCategory">Company Category <span class="required">*</span></label> <input
					type="text" id="companyCategory" name="companyCategory"
					value="Trading and Finance" required><br> <br> <label
					for="topSkills">Top Skills <span class="required">*</span></label> <input type="text"
        ...
        <label for="courseVideoName1">Course Video Name 1 <span class="required">*</span></label>
        <input type="text" id="courseVideoName1" name="courseVideoName1" value="Investing Basics: forex" required><br><br>

        <label for="courseVideoName2">Course Video Name 2 <span class="required">*</span></label>
        <input type="text" id="courseVideoName2" name="courseVideoName2" value="forex rules and Principles" required><br><br>

        <label for="courseVideoName3">Course Video Name 3 <span class="required">*</span></label>
