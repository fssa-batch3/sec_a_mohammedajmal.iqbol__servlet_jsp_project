...
<body>
		...
		<div class="heropageletters">
			...
			<div class="herobtnimgflex">
				...
				<div class="herouserpara">
					<span>500 members joined us <br> in the past 7-days.
					</span>
				</div>
			</div>
	...
	<div class="fourthpage">
		...
		<div class="fourthpageletters">
			...
			<br>
			<button class="statsbtn1">Become a Member</button>
		</div>
		...
		<div class="customerreviewsdiv">
			...
			<div class="customerreviewsdiv1">
				...
				<p class="customerreviewspara2">
					“I had been using this web platform since now. It's service is
					best and cheap that nobody can give.<br> It gives me a lot of
		...
		<div class="getstarteddiv">
			...
			<div class="getstarteddiv1">
				...
				<img class="getstartedimg"
					...
					alt="create-account-image" /> <span class="getstartedspan1">1</span>
			...
			<div class="getstarteddiv2">
				<img class="getstartedimg2"
					...
					alt="deposit-money-image" /> <span class="getstartedspan2">2</span>
			...
			<div class="getstarteddiv3">
				<img class="getstartedimg"
					...
					alt="trade-image" /> <span class="getstartedspan3">3</span>
